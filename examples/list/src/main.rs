...
pub fn main() {
    ...
    let component_name = "ListItem #transform #layout #component #clickable".to_string();
    ...
    guppy.register(move |event, gpu_redraws| {
        ...
        gpu_redraws[0].update_triangles(
            list_1
                ...
                .extend(&list_3.get_combined_geometries())
